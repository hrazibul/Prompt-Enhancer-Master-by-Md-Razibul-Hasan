  ...
  return (
    <header className="py-4">
      <div className="container mx-auto px-4 flex justify-between items-center">
        ...
        <button className="flex items-center gap-2 text-sm font-medium border border-gray-700 hover:border-gray-500 bg-gray-800/50 hover:bg-gray-700/50 px-3 sm:px-4 py-2 rounded-lg transition-colors">
